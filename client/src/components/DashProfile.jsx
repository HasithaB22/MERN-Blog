        ...
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                {imageFileUploadError && (
                    <Alert color="failure" className="font-semibold">{imageFileUploadError}</Alert>
                )}
            ...
            {updateUserSuccess && (
                <Alert color="success" className=" mt-5 font-semibold">{updateUserSuccess}</Alert>
            )}

            {updateUserError && (
                <Alert color="failure" className=" mt-5 font-semibold">{updateUserError}</Alert>
            )}
        </div>
    )
}
